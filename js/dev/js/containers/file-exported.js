...
class FileExported extends Component {
	...
	componentWillReceiveProps(nextProps) {
		...
		this.setState({fileValues : nextProps['fileExported'], fileName : nextProps.clickedFileId.clickedFileName});
		this.props.getImageCollection(this.state.imageCol);
	}
	
	createListItems() {
		 
		if(this.state && this.state.fileValues && this.state.fileValues.length) {
