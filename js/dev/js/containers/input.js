...
class Input extends Component {
    ...
    render() {
        ...
        return React.createElement('textarea', {
			...
			onDoubleClick : (e) => {
				var metaData = {
					dataRowIndex : this.props['data-row-index'],
					dataCellIndex : this.props['data-cell-index'],
					dataSheetName : this.props['data-sheet-name']
				};
				this.props.getInputMetaDataForAsanaPopup(metaData);
			},
			onBlur : function(e) {
				if(this.state.changed) {
					...
					this.props['data-row-index'], 
					this.props['data-cell-index'],
					this.props['data-sheet-name'],
					oldValue
					]);
			}
		}.bind(this),
