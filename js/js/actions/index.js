...
export const getCommentsFromDataBaseFile = (comments) => {
	return {
		type : "GET_COMMENTS_FROM_DATABASE_FILE_ON_PROJECTS_UPDATE",
		payload : comments
	}
};


export const getGapiLoggedInUser = (gapiUser) => {
	return {
		type : "GLOBAL_GAPI_USER_LOGGED_IN",
		payload : gapiUser
	}
};
